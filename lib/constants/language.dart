...
class Language extends Strings with ChangeNotifier {
  ...
  Future<void> set({
    ...
    ADD = map['ADD']!;
    ADD_LIBRARY_TO_PLAYLIST_WHEN_PLAYING_FROM_TRACKS_TAB =
        map['ADD_LIBRARY_TO_PLAYLIST_WHEN_PLAYING_FROM_TRACKS_TAB']!;
    ...
    ALBUM_THUMBNAIL_SIZE_IN_LIST = map['ALBUM_THUMBNAIL_SIZE_IN_LIST']!;
    ALBUM_TILE_HEIGHT_RESET_TO_DEFAULT =
        map['ALBUM_TILE_HEIGHT_RESET_TO_DEFAULT']!;
    ALL_FILES = map['ALL_FILES']!;
    ARTIST = map['ARTIST']!;
    ARTIST_SINGLE = map['ARTIST_SINGLE']!;
    ASCENDING = map['ASCENDING']!;
    AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING =
        map['AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING']!;
    AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING_TITLE =
        map['AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING_TITLE']!;
    ...
    BETA = map['BETA']!;
    BORDER_RADIUS_MULTIPLIER = map['BORDER_RADIUS_MULTIPLIER']!;
    BORDER_RADIUS_MULTIPLIER_RESET_TO_DEFAULT =
        map['BORDER_RADIUS_MULTIPLIER_RESET_TO_DEFAULT']!;
    BUFFERING = map['BUFFERING']!;
    CANCEL = map['CANCEL']!;
    CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC =
        map['CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC']!;
    CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC_TITLE =
        map['CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC_TITLE']!;
    CLEAR_LRC_FILE = map['CLEAR_LRC_FILE']!;
    COLLECTION = map['COLLECTION']!;
    COLLECTION_ALBUM_DELETE_DIALOG_BODY =
        map['COLLECTION_ALBUM_DELETE_DIALOG_BODY']!;
    COLLECTION_ALBUM_DELETE_DIALOG_HEADER =
        map['COLLECTION_ALBUM_DELETE_DIALOG_HEADER']!;
    COLLECTION_INDEXING_HINT = map['COLLECTION_INDEXING_HINT']!;
    COLLECTION_INDEXING_LABEL = map['COLLECTION_INDEXING_LABEL']!;
    COLLECTION_PLAYLIST_DELETE_DIALOG_BODY =
        map['COLLECTION_PLAYLIST_DELETE_DIALOG_BODY']!;
    COLLECTION_PLAYLIST_DELETE_DIALOG_HEADER =
        map['COLLECTION_PLAYLIST_DELETE_DIALOG_HEADER']!;
    COLLECTION_SEARCH_LABEL = map['COLLECTION_SEARCH_LABEL']!;
    COLLECTION_SEARCH_NO_RESULTS_SUBTITLE =
        map['COLLECTION_SEARCH_NO_RESULTS_SUBTITLE']!;
    COLLECTION_SEARCH_NO_RESULTS_TITLE =
        map['COLLECTION_SEARCH_NO_RESULTS_TITLE']!;
    ...
    COLLECTION_TRACK_DELETE_DIALOG_BODY =
        map['COLLECTION_TRACK_DELETE_DIALOG_BODY']!;
    COLLECTION_TRACK_DELETE_DIALOG_HEADER =
        map['COLLECTION_TRACK_DELETE_DIALOG_HEADER']!;
    COLLECTION_TRACK_PLAYLIST_REMOVE_DIALOG_BODY =
        map['COLLECTION_TRACK_PLAYLIST_REMOVE_DIALOG_BODY']!;
    ...
    CUSTOMIZATIONS_SUBTITLE = map['CUSTOMIZATIONS_SUBTITLE']!;
    DATE_ADDED = map['DATE_ADDED']!;
    DATE_TIME_FORMAT = map['DATE_TIME_FORMAT']!;
    DATE_TIME_FORMAT_RESET_TO_DEFAULT =
        map['DATE_TIME_FORMAT_RESET_TO_DEFAULT']!;
    DELETE = map['DELETE']!;
    ...
    DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE =
        map['DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE']!;
    DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE_SUBTITLE =
        map['DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE_SUBTITLE']!;
    DISPLAY_AUDIO_FORMAT = map['DISPLAY_AUDIO_FORMAT']!;
    DISPLAY_THIRD_ITEM_IN_ROW_IN_TRACK_TILE =
        map['DISPLAY_THIRD_ITEM_IN_ROW_IN_TRACK_TILE']!;
    DISPLAY_THIRD_ROW_IN_TRACK_TILE = map['DISPLAY_THIRD_ROW_IN_TRACK_TILE']!;
    DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE =
        map['DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE']!;
    DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE_SUBTITLE =
        map['DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE_SUBTITLE']!;
    DONATE = map['DONATE']!;
    DONE = map['DONE']!;
    ...
    ENABLE_BLUR_EFFECT = map['ENABLE_BLUR_EFFECT']!;
    ENABLE_DISCORD_RPC = map['ENABLE_DISCORD_RPC']!;
    ENABLE_GLOW_EFFECT = map['ENABLE_GLOW_EFFECT']!;
    ENTER_YOUR_OWN_FORMAT_HERE = map['ENTER_YOUR_OWN_FORMAT_HERE']!;
    ERROR = map['ERROR']!;
    ...
    FORCE_SQUARED_ALBUM_THUMBNAIL = map['FORCE_SQUARED_ALBUM_THUMBNAIL']!;
    FORCE_SQUARED_TRACK_THUMBNAIL = map['FORCE_SQUARED_TRACK_THUMBNAIL']!;
    FULLSCREEN = map['FULLSCREEN']!;
    GENRE = map['GENRE']!;
    GO_TO_SETTINGS = map['GO_TO_SETTINGS']!;
    HEIGHT_OF_ALBUM_TILE = map['HEIGHT_OF_ALBUM_TILE']!;
    HEIGHT_OF_TRACK_TILE = map['HEIGHT_OF_TRACK_TILE']!;
    HIDE = map['HIDE']!;
    HIDE_LYRICS = map['HIDE_LYRICS']!;
    HIGHLIGHTED_LYRICS_SIZE = map['HIGHLIGHTED_LYRICS_SIZE']!;
    HISTORY = map['HISTORY']!;
    HOUR_FORMAT_12 = map['HOUR_FORMAT_12']!;
    IMAGES = map['IMAGES']!;
    IMPORT = map['IMPORT']!;
    ...
    INDEXING_ALREADY_GOING_ON_SUBTITLE =
        map['INDEXING_ALREADY_GOING_ON_SUBTITLE']!;
    ...
    LAST_COLLECTION_DIRECTORY_REMOVED =
        map['LAST_COLLECTION_DIRECTORY_REMOVED']!;
    LESS = map['LESS']!;
    ...
    MOBILE_ENABLE_NOW_PLAYING_RIPPLE_EFFECT =
        map['MOBILE_ENABLE_NOW_PLAYING_RIPPLE_EFFECT']!;
    ...
    NOW_PLAYING_SCREEN_SETTING_SUBTITLE =
        map['NOW_PLAYING_SCREEN_SETTING_SUBTITLE']!;
    ...
    PERMISSION_IMAGES_AND_PHOTOS_SUBTITLE =
        map['PERMISSION_IMAGES_AND_PHOTOS_SUBTITLE']!;
    PERMISSION_MUSIC_AND_AUDIO = map['PERMISSION_MUSIC_AND_AUDIO']!;
    PERMISSION_MUSIC_AND_AUDIO_SUBTITLE =
        map['PERMISSION_MUSIC_AND_AUDIO_SUBTITLE']!;
    PERMISSION_NOTIFICATIONS = map['PERMISSION_NOTIFICATIONS']!;
    PERMISSION_NOTIFICATIONS_SUBTITLE =
        map['PERMISSION_NOTIFICATIONS_SUBTITLE']!;
    PHONE = map['PHONE']!;
    PITCH = map['PITCH']!;
    PLAY = map['PLAY']!;
    ...
    RENAME = map['RENAME']!;
    REPEAT = map['REPEAT']!;
    REQUIRES_APP_RESTART = map['REQUIRES_APP_RESTART']!;
    ...
    SETTING_INDEXING_LINEAR_PROGRESS_INDICATOR =
        map['SETTING_INDEXING_LINEAR_PROGRESS_INDICATOR']!;
    ...
    SHOW_NOW_PLAYING_AFTER_PLAYING_SUBTITLE =
        map['SHOW_NOW_PLAYING_AFTER_PLAYING_SUBTITLE']!;
    SHOW_NOW_PLAYING_SCREEN = map['SHOW_NOW_PLAYING_SCREEN']!;
    SHOW_TRACK_PROGRESS_ON_TASKBAR = map['SHOW_TRACK_PROGRESS_ON_TASKBAR']!;
    SHOW_TRACK_PROGRESS_ON_TASKBAR_SUBTITLE =
        map['SHOW_TRACK_PROGRESS_ON_TASKBAR_SUBTITLE']!;
    SHUFFLE = map['SHUFFLE']!;
    SIZE_OF_ALBUM_THUMBNAIL_RESET_TO_DEFAULT =
        map['SIZE_OF_ALBUM_THUMBNAIL_RESET_TO_DEFAULT']!;
    SIZE_OF_TRACK_THUMBNAIL_RESET_TO_DEFAULT =
        map['SIZE_OF_TRACK_THUMBNAIL_RESET_TO_DEFAULT']!;
    SORT = map['SORT']!;
    SORT_BY = map['SORT_BY']!;
    SPEED = map['SPEED']!;
    STAGGERED_ALBUM_GRID_VIEW = map['STAGGERED_ALBUM_GRID_VIEW']!;
    ...
    STICKY_MINIPLAYER_SUBTITLE = map['STICKY_MINIPLAYER_SUBTITLE']!;
    STREAM = map['STREAM']!;
    ...
    TRACK_THUMBNAIL_SIZE_IN_LIST = map['TRACK_THUMBNAIL_SIZE_IN_LIST']!;
    TRACK_TILE_CUSTOMIZATION = map['TRACK_TILE_CUSTOMIZATION']!;
    TRACK_TILE_HEIGHT_RESET_TO_DEFAULT =
        map['TRACK_TILE_HEIGHT_RESET_TO_DEFAULT']!;
    TRACK_TILE_ITEMS_SEPARATOR = map['TRACK_TILE_ITEMS_SEPARATOR']!;
    ...
    USE_LRC_FILE_FROM_TRACK_DIRECTORY =
        map['USE_LRC_FILE_FROM_TRACK_DIRECTORY']!;
    USE_MODERN_LAYOUT = map['USE_MODERN_LAYOUT']!;
    USE_MODERN_LAYOUT_SUBTITLE = map['USE_MODERN_LAYOUT_SUBTITLE']!;
    USE_MODERN_NOW_PLAYING_SCREEN = map['USE_MODERN_NOW_PLAYING_SCREEN']!;
    USE_THESE_CHARACTERS_TO_SEPARATE_ARTISTS =
        map['USE_THESE_CHARACTERS_TO_SEPARATE_ARTISTS']!;
    VALUE = map['VALUE']!;
