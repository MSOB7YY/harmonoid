                          ...
                          children: [
                            ...
                            Positioned(
                              ...
                              child: BlurryContainer(
                                ...
                                blur: Configuration.instance.enableBlurEffect
                                    ? 5
                                    : 0,
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            ExtendedImage(
                                                                          image:
                                                                              Image(image: getAlbumArt(Playback.instance.tracks[i])).image,
                                                                          fit: BoxFit
                                                                              .cover,
                                                                              ...
                                                                              case LoadState.failed:
                                                                                {
                                                                                  if (LibmpvPluginUtils.isSupported(Playback.instance.tracks[i].uri)) {
                                                                                    ...
                                                                                    return ExtendedImage(image: Image(image: getAlbumArt(Playback.instance.tracks[i], small: true)).image, fit: BoxFit.cover, width: Configuration.instance.forceSquaredTrackThumbnail ? MediaQuery.of(context).size.width : null, height: Configuration.instance.forceSquaredTrackThumbnail ? MediaQuery.of(context).size.width : null);
                                                                                  }
                                                        ...
                                                        (Playback.instance
                                                            ...
                                                            : IconButton(
                                                                onPressed: () {
                                                                  if (collection
                                                                    ...
                                                                    collection
                                                                      ...
                                                                      collection
                                                                          .likedSongsPlaylist,
                                                                      Playback.instance.tracks[Playback
                                                                          .instance
                                                                          .index],
                                                                    );
                                                                  } else {
                                                                ...
                                                                icon: Icon(
                                                                  () {
                                                                    try {
                                                                      return collection.likedSongsPlaylist.tracks.contains(Playback.instance.tracks[Playback
                                                                              .instance
                                                                              .index])
                                                                          ? Icons
                                                                              .favorite
                                                                        ...
                                                                        PopupMenuItem(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            leading:
                                                                                Icon(Icons.link),
                                                                            title:
                                                                                Text(Language.instance.COPY_LINK),
                                                                          ),
                                                                        ),
                                                                      if (LibmpvPluginUtils
                                                                          .isSupported(
                                                                        ...
                                                                        PopupMenuItem(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            title:
                                                                                Text(Language.instance.OPEN_IN_BROWSER),
                                                                          ),
                                                                        ),
                                                                      PopupMenuItem(
                                                                        onTap: () =>
