                    ...
                    ? DraggableScrollbar.semicircle(
                        ...
                        labelTextBuilder: (offset) {
                          ...
                          switch (Collection.instance.albumsSort) {
                            ...
                            case AlbumsSort.year:
                              {
                                return Text(
                                  '${album.year.length == 8 ? formatDate.format(DateTime.parse(album.year)) : album.year}',
                                  style: Theme.of(context)
                                      .textTheme
                                      .headlineMedium,
                                );
                        ...
                        child: MasonryGridView.builder(
                          ...
                          padding: EdgeInsets.only(
                              top: kDetailsAreaHeight +
                                  kMobileBottomPaddingSmall * 0.5,
                          ...
                          itemCount: Collection.instance.albums.length,
                          gridDelegate:
...
class AlbumTileModern extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<Iterable<Color>?> albumColor;
    final tracks = album.tracks.toList();
    albumColor = getAlbumColorModern(media: album);
    int totalAlbumDuration =
        getTotalTracksDuration(album: album, tracks: album.tracks.toList());
        ...
        children: [
          Text(
            ...
            style: Theme.of(context).textTheme.displayMedium?.copyWith(
                  fontSize: helper.albumTileNormalDensity ? 18.0 : 14.0,
                  fontWeight:
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(height: 8.0),
                                                  Text(
                                                    '${Language.instance.ARTIST}: ${widget.album.albumArtistName}\n${Language.instance.YEAR}: ${widget.album.year.length == 8 ? formatDate.format(DateTime.parse(widget.album.year)) : widget.album.year}\n${Language.instance.TRACK}: ${tracks.length}',
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .displaySmall,
                                                    overflow:
                              ...
                              (context, i) {
                                return Material(
                                  ...
                                  child: InkWell(
                                    ...
                                    onLongPress: () =>
                                        showTrackDialog(context, tracks[i]),
                                    child: Column(
                                      mainAxisAlignment:
                                          MainAxisAlignment.center,
                                      children: [
                          ...
                          SliverPadding(
                            padding: EdgeInsets.only(
                              ...
                              bottom: Configuration.instance.stickyMiniplayer &&
                                      !MobileNowPlayingController
                                          .instance.isHidden
                                  ? kMobileNowPlayingBarHeight * 0.9
                                  : 0,
                            ),
                          ),
                        ],
                                                                ...
                                                                if (![
                                                                  ...
                                                                  Chip(
                                                                    ...
                                                                    label:
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${widget.album.year.length == 8 ? formatDate.format(DateTime.parse(widget.album.year)) : widget.album.year}',
                                                                        style: Theme.of(context)
                                                                            .textTheme
                                                                            .titleLarge
                                                                            ?.copyWith(
