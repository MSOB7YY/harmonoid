  ...
  Future<void> listener() async {
    ...
    for (final media in result) {
      ...
      if (media is Artist) {
        ...
        // play all the tracks from search result

        tracks.add(
          TrackTileModern(
            track: media,
            index: tracksOnly.indexOf(media),
            group: tracksOnly,
            onPressed: () {
              Playback.instance.open(
                tracksOnly,
        ...
        //         if (item.albumName == media.albumName &&
        //             item.albumArtistName == media.albumArtistName) {
        //           album = item;
        //           break;
        //         }
        //       }
        //       Playback.instance.open(
        //         album.tracks.toList(),
        //         index: album.tracks.toList().indexOf(media),
        //       );
        //       // UNCOMMENT IF YOU WANT TO INSERT SELECTED TRACK AT THE FIRST INDEX
        //       // Playback.instance.tracks = [];
        //       // Playback.instance.tracks.add(media);
        //       // Playback.instance.tracks.addAll(album.tracks.toList());
