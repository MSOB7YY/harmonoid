...
class FileInfoScreenModern extends StatefulWidget {
  ...
  @override
  State<FileInfoScreenModern> createState() => _FileInfoScreenModernState();
}

class _FileInfoScreenModernState extends State<FileInfoScreenModern> {
  Track? track;
  Tagger? tagger;
  TaggerClient? client;
